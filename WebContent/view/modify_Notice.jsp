...
<div class="student" style="width: 400px;height: 300px">
    <form id="modify_form">
    标题：<br>
    	<input type="hidden" name="id" id="modify_id" placeholder="选项卡标题"  style="width: 95%" value="${notice.id}"/>
    	<input type="text" name="title" id="modify_title" placeholder="选项卡标题"  style="width: 95%" value="${notice.title}"/>
   内容：<br>
		<textarea placeholder="选项相应内容" name="content" id="modify_content" style="width: 95%;height: 200px;">${notice.content}</textarea> 
    <center>
